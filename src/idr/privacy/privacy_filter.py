...
class PrivacyFilter:
    ...
    def __init__(
        self,
        bidder_configs: Optional[dict[str, BidderPrivacyRequirements]] = None,
    ...
    def get_privacy_summary(
        ...
        return {
            ...
            'ccpa_opted_out': consent.us_privacy.has_opted_out() if consent.us_privacy else False,
        }
...
def infer_privacy_jurisdiction(country: str, region: str = "") -> set[PrivacyRegulation]:
    """
